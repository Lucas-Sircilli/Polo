...
<html lang="pt-br">
   ...
   <script type="text/javascript">
      ...
      function EditarEmpresa(id) {
        CarregaLoader();
        location.href = "http://polo.gvdsolucoes.com.br/empresasCRUD.php?id="+id;
        /*  var w = window.open("http://polo.gvdsolucoes.com.br/empresasCRUD.php?id="+id);
      ...
      function AdicionarEmpresa() {
          CarregaLoader();
           location.href = "http://polo.gvdsolucoes.com.br/empresasCRUD.php?id="+0;
         /* var w = window.open("http://polo.gvdsolucoes.com.br/empresasCRUD.php?id="+0);
          w.addEventListener("load", function(event) {
            location.reload();
  });*/
      }
                     ...
                     <?php
                        if ($result->num_rows > 0) {
                            for ($i = 0; $i < $result->num_rows; $i++) {
                                ...
                                echo "<tr>
                                    <td nowrap>" . $row["id_empresas"] . "</td>
                                    <td nowrap>" . ($row["razao_social"]) . "</td>
                                    <td nowrap>" . ($row["cnpj"]) ."</td>
                                    <td nowrap>" . ($row["endereco"]) . "</td>
                                    <td nowrap>" . ($row["whatsapp"]) . "</td>
                                    <td nowrap>" . ($row["email"]) ."</td>
                                    <td nowrap>" . ($row["responsavel"]) . "</td>
