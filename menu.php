<style>
   ...
   .navbar-brand {
   background-image: url('./imagens/Logo-Polo-Login.png');
...
<nav class="navbar">
   <div class="container-fluid">
      ...
      <div class="row" style="background-color: #e03a28; padding-bottom: 5px; padding-top: 5px;">
         <div class="col-sm-12 text-right" style="color: white;"><b><?= $TituloPage ?></b></div>
      </div>
   </div>
</nav>
