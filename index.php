...
<html lang="pt-br">
   <head>
      ...
      <title>Polo Arquitetura - Login</title>
      <!-- Bootstrap core CSS -->
      ...
      <style>
         ...
         body{
         background-image: url("imagens/Tela-Login-Polo.png") ;
   ...
   <body>
       <div id="loading" style="display:none !important">
          <img id="loading-image" src="./imagens/loader-polo.gif" alt="Loading..." />
       </div>
      <div class="container text-center">
         <img src="./imagens/Logo-Polo-Login.png" style="height:20vh"/>
         <form class="form-signin" method="POST"  onsubmit="CarregaLoader()" action="valida.php">
            ...
            <div class="checkbox">
               <label><input type="checkbox" name="chkLGPD" id="chkLGPD" value="sim"  required>Concordo com os a <a href="arquivos/privacidadew.pdf" target="_blank">Política de Privacidade</a></label>
            </div>
