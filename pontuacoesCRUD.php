...
<html lang="pt-br">
   ...
   <script type="text/javascript">
      ...
      function Cancelar(){
          location.href= "http://polo.gvdsolucoes.com.br/pontuacoes.php";
          // history.back();
      ...
      function GravarPontuacao() {
          ...
          for (var i = 0; i < $("#eObras").children().length; i++){
              ...
              if(document.getElementById('eObras'+ i).checked){
         ...
         // dataU.Fase = $("#eFase").children("option:selected")[0].innerText;
                     ...
                     <div class="panel-body">
                        <div class="row">
                           ...
                           <div class="form-group form-group-sm col-sm-10">
                              ...
                              <select class="form-control" id="eEmpresas" name="eEmpresas" onchange="BuscaVendedor()">
                              <?php
                     ...
                     <div class="panel-body">
                        <div class="row">
                           <div class="form-group form-group-sm col-sm-6">
                              ...
                              <?php
                                 $sqlparceiro = "SELECT * FROM parceiros";
                        ...
                        <div class="row">
                           <div class="form-group form-group-sm col-sm-12">
                              ...
                              <div class="radio" id="eObras" name="eObras">
                              </div>
                           </div>
                        </div>
                     </div>
               ...
               <div class="modal-body">
                  ...
                  <div class="row">
                     ...
                     <div class="form-group form-group-sm col-sm-3">
                        ...
                        <select class="form-control" name="eFasesObra"  id="eFasesObra" >
